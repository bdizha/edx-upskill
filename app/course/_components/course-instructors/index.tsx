  ...
  const instructors = [
    {
      id: 1,
      name: "John Guttag",
      imageUrl: "https://prod-discovery.edx-cdn.org/media/people/profile_images/844aa675-750c-4b1a-aed1-466aa69463a7-c9df666ee72c.jpg",
    ...
    },
    {
      id: 2,
      name: "Eric Grimson",
      imageUrl: "https://prod-discovery.edx-cdn.org/media/people/profile_images/e5cf80a8-0063-407c-9376-36c5043ddf47-f51710f41c25.jpg",
    ...
    },
    {
      id: 3,
      name: "Ana Bell",
      imageUrl: "https://prod-discovery.edx-cdn.org/media/people/profile_images/e1767c5b-6746-4a05-965e-24c384246ecb-bdb98aa20544.jpg",
    ...
    <Container className="mt-12" size="lg">
      <Row className="my-3">
        <Col xs={12} sm={12} lg={12} xl={12}>
          <h1 className="text-center mb-3">About the instructors</h1>
          <div className="row gx-4">
            {instructors.map((instructor) => (
              <Col className="mb-3" key={instructor.id} xs={12} sm={12} lg={4} xl={4}>
                <InstructorCard
